...
function initContactForm() {
        ...
        enhancedLetter.innerHTML = `
            <div class="letter-envelope">
                ...
                <div class="letter-content">
                    <div class="letter-header">To: Arpitha Medarametla</div>
    ...
    function createNavbarSuccessBurst() {
        ...
        burst.innerHTML = `
            ...
            <div class="success-message">📧 Message Sent to Arpitha Medarametla!</div>
        `;
            ...
            if (messageElement) {
                messageElement.innerHTML = `
                    <div class="epic-success-message">
                        ...
                        <br>
                        <span class="signature-text">- Arpitha Medarametla 💫</span>
                    </div>
                `;
            }
